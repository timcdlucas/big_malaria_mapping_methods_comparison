...
plot(m_base_r$results$MAE ~ m_base_r$results$max_depth)
plot(m_base_r$results$MAE ~ m_base_r$results$eta)
plot(m_base_r$results$MAE ~ m_base_r$results$gamma)

plot(m_base_r$results$MAE ~ m_base_r$results$colsample_bytree)
(m_base_r$results$MAE ~ m_base_r$results$subsample)
(m_base_r$results$MAE ~ m_base_r$results$nrounds)
